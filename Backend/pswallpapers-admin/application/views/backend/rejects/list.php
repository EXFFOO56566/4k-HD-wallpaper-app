			...
			<?php foreach($rejects->result() as $rejcet): ?>
				...
				<tr>
					...
					<?php 
						...
						$default_photo = get_default_photo( $rejcet->wallpaper_id, 'wallpaper' );
						$default_video_icon = get_default_photo( $rejcet->wallpaper_id, 'video-icon' );
