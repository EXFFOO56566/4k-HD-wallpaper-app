            ...
            <div class="row">
						...
						<div class="form-group" style="padding-top: 30px;">
							<div>
						        <label><input type="radio" name="wallpaperRadio" value="is_wallpaper" disabled <?php 
									       		$is_wallpaper = $reject->is_wallpaper;
									       		$is_gif = $reject->is_gif;
						        ...
						        <label class="pull-right"><input type="radio" name="wallpaperRadio" value="is_video_wallpaper" disabled <?php 
									       		$is_video_wallpaper = $reject->is_video_wallpaper;
									        if ($is_video_wallpaper == 1) echo "checked"; ?> > <?php echo get_msg('is_video_wallpaper'); ?> </label>
						        
						    </div>
						    
						    <?php 
						    	if($reject->is_wallpaper == 1 || $reject->is_gif == 1) {
						    		$display = "block";
						    	} else {
						    		$display = "none";
						    	}
						    ...
						    <?php 
						    	if($reject->is_video_wallpaper == 1) {
						    		$display = "block";
						    	} else {
						    		$display = "none";
						    	}
						    ...
						    <div class="is_video_wallpaper box" style="display: <?php echo $display; ?> ">
								...
								<?php
									$conds = array( 'img_type' => 'video', 'img_parent_id' => $reject->wallpaper_id );
                ...
                <div class="col-md-6">
					...
					<div class="form-group">
						...
						<?php echo form_input( array(
							'name' => 'credit',
							'value' => set_value( 'credit', show_data( @$reject->credit ), false ),
							'class' => 'form-control form-control-sm',
		        	...
		        	<div class="form-group">
						<div class="form-check">
							...
							<?php echo form_checkbox( array(
								...
								'value' => 'accept',
								'checked' => set_checkbox('wallpaper_is_published', 1, ( @$reject->wallpaper_is_published == 1 )? true: false ),
					...
					<div class="form-group">
						<div class="form-check">
							...
							<?php echo form_checkbox( array(
								...
								'id' => 'is_recommended',
								'value' => 'accept',
								'checked' => set_checkbox('is_recommended', 1, ( @$reject->is_recommended == 1 )? true: false ),
								'class' => 'form-check-input',
								'onclick' => 'return false'
							));	?>
					...
					<div class="form-group">
						<label><?php echo get_msg('wallpaper_modes_label'); ?>
							<?php 
							if ($reject->is_landscape == 1) {
								echo ": Landscape";
							} else if ($reject->is_portrait == 1) {
								echo ": Portrait";
							} else if ($reject->is_square == 1) {
								echo ": Square";
							}
							?>
						</label>
