<div class="table-responsive animated fadeInRight">
	<table class="table m-0 table-striped">
		<tr>
			...
			<th><?php echo get_msg('cat_img'); ?></th>
			<th><?php echo get_msg('wallpaper_count'); ?></th>
	...
	<?php if ( !empty( $categories ) && count( $categories->result()) > 0 ): ?>
		...
		<?php foreach($categories->result() as $category): ?>
			...
			<tr>
				...
				<td><img src="<?php echo img_url( '/thumbnail/'. $default_photo->img_path ); ?>"/></td>
				<td><?php 
				$conds['cat_id'] = $category->cat_id;
				echo $this->Wallpaper->count_all_by($conds); ?></td>
				<?php if ( $this->ps_auth->has_access( EDIT )): ?>
				...
				<?php if ( $this->ps_auth->has_access( PUBLISH )): ?>
					...
					<td>
						<?php if ( @$category->cat_is_published == 1): ?>
