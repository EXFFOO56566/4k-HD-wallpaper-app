...
<?php
	...
	$data = array(
		'title' => get_msg( 'delete_wallpaper_label' ),
		'message' => get_msg( 'wallpaper_delete_confirm_message' ),
		'yes_all_btn' => get_msg( 'cat_yes_all_label' ),
		'no_only_btn' => get_msg( 'wallpaper_no_only_label' )
	);
